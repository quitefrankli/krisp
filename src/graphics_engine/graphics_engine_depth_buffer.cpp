	...
	GraphicsEngineBaseModule(engine)
{
	...
	get_graphics_engine().texture_mgr.create_image(extent.width,
												   extent.height,
												   depth_format,
	...
	view = get_graphics_engine().texture_mgr.create_image_view(image, depth_format, VK_IMAGE_ASPECT_DEPTH_BIT);
}
