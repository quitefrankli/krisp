...
void GraphicsEngineFrame::create_descriptor_sets(GraphicsEngineObject& object)
{
	...
	for (int vertex_set_index = 0; vertex_set_index < cur_vertex_sets.size(); vertex_set_index++)
	{
		...
		image_info.imageView = get_graphics_engine().texture_mgr.get_texture_image(); // TODO: move this to object
		image_info.sampler = get_graphics_engine().texture_mgr.get_texture_sampler(); // TODO: move this to object
