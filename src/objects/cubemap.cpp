...
CubeMap::CubeMap()
{
	...
	{
		const auto texture_path = Utility::get_texture(fmt::format("skybox/{}.jpg", texture_name));
		material_group.cube_map_mats.push_back(ResourceLoader::fetch_texture(texture_path));
	}
