...
static_assert(sizeof(SDS::MaterialData) == 32);
static_assert(offsetof(SDS::MaterialData, base_color_factor) == 0);
static_assert(offsetof(SDS::MaterialData, metallic_factor) == 16);
static_assert(offsetof(SDS::MaterialData, roughness_factor) == 20);
